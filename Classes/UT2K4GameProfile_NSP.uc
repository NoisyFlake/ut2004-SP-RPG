...
//
//-----------------------------------------------------------
class UT2K4GameProfile_NSP extends UT2K4GameProfile;
...
function Initialize(GameInfo currentGame, string pn)
{
	...
	{
		UT2K4GameLadder = class<UT2K4LadderInfo_NSP>(DynamicLoadObject(GameLadderName, class'Class'));
...
{
     Balance=500
     msgCheater="FUCKING CHEATER!!!"
     GameLadderName="NewSinglePlayer.UT2K4LadderInfo_NSP"
}
