...
//
//-----------------------------------------------------------
class UT2K4SP_Main_NSP extends UT2K4SP_Main;

var UT2K4GameProfile_NSP GP;
...
function UpdateTabs(optional bool bPurge, optional bool bSetActive)
{
	...
	GP = UT2K4GameProfile_NSP(PlayerOwner().Level.Game.CurrentGameProfile);
	if ((GP == none) || (bPurge))
	{
...
defaultproperties
{
     PanelClass(1)="NewSinglePlayer.UT2K4SPTab_ProfileNew_NSP"
}
